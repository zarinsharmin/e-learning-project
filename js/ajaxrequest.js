  ...
  $("#stuemail").on("keypress blur", function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (stuemail == "") {
          $("#statusMsg2").html(
            '<small style="color:green;">Please Enter Email!</small>'
          );
        }
      },
    });
...
function addStu() {
  ...
  if (stuname.trim() == "") {
    ...
    $("#statusMsg2").html(
      '<small style="color:red;">Please Enter Email Address</small>'
    );
    $("#stuemail").focus();
    return false;
  } else if (stuemail.trim() != "" && !reg.test(stuemail)) {
    $("#statusMsg2").html(
      '<small style="color:red;">Please Enter Valid Email e.g. abc@gmail.com</small>'
    );
    $("#stuemail").focus();
    return false;
