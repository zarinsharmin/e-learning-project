...
if(isset($_REQUEST['requpdate'])){
    ...
    if(($_REQUEST['course_id'] == "") || ($_REQUEST['course_name'] == "") || ($_REQUEST['course_desc'] == "") || ($_REQUEST['course_id'] == "") || ($_REQUEST['course_id'] == "") || ($_REQUEST['course_author'] == "") || ($_REQUEST['course_duration'] == "") || ($_REQUEST['course_price'] == "") || ($_REQUEST['course_original_price'] == "")){
        ...
        $cimg = '../img/courseimage/'.$_FILES['course_img']['name'];
